...
#   --job.dump_folder exp/delta_net_340M/batch32.seqlen2048.warmup1024.update1.steps8000.lr3e-4 \
...
# NNODE=1 NGPU=8 LOG_RANK=0 bash train.sh \
#   --job.config_file flame/models/fla.toml \
#   --job.dump_folder exp/test_EFLA/batch32.seqlen2048.warmup1024.update1.steps14500.lr3e-4 \
#   --model.config configs/delta_net_340M.json \
#   --model.tokenizer_path mistralai/Mistral-7B-v0.1 \
#   --optimizer.name AdamW \
#   --optimizer.eps 1e-15 \
...
# NNODE=1 NGPU=8 LOG_RANK=0 bash train.sh \
#   --job.config_file flame/models/fla.toml \
#   --job.dump_folder exp/delta_net_1B/batch32.seqlen2048.warmup1024.update1.steps48000.lr3e-4 \
...
NNODE=1 NGPU=8 LOG_RANK=0 bash train.sh \
  --job.config_file flame/models/fla.toml \
  --job.dump_folder exp/delta_net_1B_EFLA_loose_beta/batch32.seqlen2048.warmup1024.update1.steps24000.lr3e-4 \
  --model.config configs/delta_net_1B.json \
  --model.tokenizer_path mistralai/Mistral-7B-v0.1 \
  --optimizer.name AdamW \
  --optimizer.eps 1e-15 \
